...
class SequenceResetTest {
    ...
    @Test
    @org.junit.jupiter.api.condition.EnabledIfSystemProperty(named = "test.sequence.isolation", matches = "true", disabledReason = "This test is disabled by default because it's sensitive to Hibernate's sequence allocation strategy when run with other tests. "
            +
