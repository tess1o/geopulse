...
class UserNotificationServicesIntegrationTest {
    ...
    void shouldBeIdempotentByDedupeAndSyncDeliveryStatus() {
        ...
        assertThat(userNotificationRepository.count()).isEqualTo(1L);
        UserNotificationEntity persisted = userNotificationRepository.findByDedupeKey("geofence-event:1002").orElseThrow();
        ...
        Optional<UserNotificationEntity> updated = userNotificationRepository.findByDedupeKey("geofence-event:1002");
