...
class TimelineConfigurationIntegrationTest {
    ...
    public static class TestConfigProfile implements io.quarkus.test.junit.QuarkusTestProfile {
        ...
        public java.util.Map<String, String> getConfigOverrides() {
            return java.util.Map.ofEntries(java.util.Map.entry("geopulse.timeline.staypoint.use_velocity_accuracy", "true"), java.util.Map.entry("geopulse.timeline.staypoint.velocity.threshold", "20.0"), java.util.Map.entry("geopulse.timeline.staypoint.accuracy.threshold", "40.0"), java.util.Map.entry("geopulse.timeline.staypoint.min_accuracy_ratio", "0.7"), java.util.Map.entry("geopulse.timeline.trip.detection.algorithm", "test_trip"), java.util.Map.entry("geopulse.timeline.staypoint.radius_meters", "200"), java.util.Map.entry("geopulse.timeline.staypoint.min_duration_minutes", "25"), java.util.Map.entry("geopulse.timeline.staypoint.merge.enabled", "true"), java.util.Map.entry("geopulse.timeline.staypoint.merge.max_distance_meters", "400"), java.util.Map.entry("geopulse.timeline.staypoint.merge.max_time_gap_minutes", "35"));
        }
    }
}
