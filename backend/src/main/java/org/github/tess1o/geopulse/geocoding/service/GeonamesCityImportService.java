...
public class GeonamesCityImportService {
    ...
    private boolean importEnabled() {
        ...
        return settingsService.getBoolean("import.geonames.cities.enabled");
    }
    ...
    private String importUrl() {
        ...
        return settingsService.getString("import.geonames.cities.url").trim();
    }
    ...
    private int batchSize() {
        ...
        return settingsService.getInteger("import.geonames.cities.batch-size");
    }
    ...
    private long minimumRowThreshold() {
        ...
        return Math.max(1, settingsService.getInteger("import.geonames.cities.min-row-threshold"));
    }
    ...
    private boolean forceRefresh() {
        ...
        return settingsService.getBoolean("import.geonames.cities.force-refresh");
    }
    ...
    private int connectTimeoutSeconds() {
        ...
        return settingsService.getInteger("import.geonames.cities.connect-timeout-seconds");
    }
    ...
    private int readTimeoutSeconds() {
        ...
        return settingsService.getInteger("import.geonames.cities.read-timeout-seconds");
    }
}
