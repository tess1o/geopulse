...
public class TimelineConfigurationProperties {
    ...
    // Staypoint Detection
    @ConfigProperty(name = "geopulse.timeline.staypoint.detection.algorithm", defaultValue = "enhanced")
    String staypointDetectionAlgorithm;
    ...
    @ConfigProperty(name = "geopulse.timeline.trip.min_distance_meters", defaultValue = "50")
    String tripMinDistanceMeters;

    @ConfigProperty(name = "geopulse.timeline.trip.min_duration_minutes", defaultValue = "7")
    String tripMinDurationMinutes;
